...
Selanjutnya fungsu untuk ekstrak zip nya
```c
void downloadDataset()
{
    char *args[] = {"/usr/local/bin/kaggle", "datasets", "download", "-d", "bryanb/fifa-player-stats-database", NULL};
...
```
 fungsi copy_data() untuk menyalin data dari file zip ke file yang diekstrak:
 ```c
 void copy_data(struct archive *ar, struct archive *aw)
{
 ...
 ```
 fungsi processFile() untuk membaca file "FIFA23_official_data.csv", memproses setiap baris, dan mencetak informasi pemain yang memenuhi kriteria tertentu:
 ```c
 void processFile()
{
 ...
 ```
 Setelah semua langkah di atas dilakukan, Anda dapat mengkompilasi dan menjalankan program Anda. Pastikan Anda memiliki library libarchive yang terpasang dan path ke binari kaggle sudah benar pada fungsi downloadDataset().
## Source code
```c
#include <stdio.h>
#include <stdlib.h>
...
```
## Test output
[![image](https://www.linkpicture.com/q/gfhg.png)](https://www.linkpicture.com/view.php?img=LPic647b15dfcad41950043695)
## Kendala
Tidak ada
---
### Kelompok ITA14:
